...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="graphs">
        	<h1>Cadastrar Fabricantes</h1>
  				<div class="panel-body">
					<form role="form" class="form-horizontal" action="add-fabricante.php" method="post" name="frmFabricante" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<div class="input-group">							
									...
									<input type="text" class="form-control1" placeholder="Fabricante" id="fabricante" name="fabricante" />
								</div>
							</div>
						</div>
						<div class="form-group">
