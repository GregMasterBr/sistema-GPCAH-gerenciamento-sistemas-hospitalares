...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="graphs">
        	<h1>Cadastrar Especialidades - Fornecedores</h1>
  				<div class="panel-body">
					<form role="form" class="form-horizontal" action="add-especialidade.php" method="post" name="frmEspecialidade" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<div class="input-group">							
									...
									<input type="text" class="form-control1" placeholder="Especialidade" id="especialidade" name="especialidade" />
								</div>
							</div>
						</div>
							<div class="form-group">
