...
<html>
<head>
<title>Plataforma :: Usuários - GPCAH</title>
 				    ...
 				    <div class="col-md-12">
					   <div class="bs-example1" data-example-id="contextual-table">
					    <table class="table">
			              ...
			              <tfoot>
			               <tr>
			               		<td colspan="7" >Usuários encontrados: <?php echo $nregistros;  ?> </td>    
			                </tr>
			              </tfoot>					      
					      <tbody>
			               <?php
			                    ...
			                    $class='';	
			                     if (($registro['status']) == 'A') {
			                      ...
			                      echo'<tr class="'.$class.'">';
			                          ...
			                          echo'<td class="text-capitalize">'.($registro['name']).'</td>';
